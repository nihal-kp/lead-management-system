...
<head>
    ...
    <meta property="og:image" content="{{asset('assets/front/images/og.jpg') }}">
    <!--begin::Fonts-->
    ...
    <link href="{{ asset('assets/plugins/custom/datatables/datatables.bundle.css?v=7.0.8') }}" rel="stylesheet"
    type="text/css" />
...
<body id="kt_body"
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center  header-mobile-fixed ">
        <!--begin::Logo-->
        <a href="index.html">
            <img alt="Logo" src="{{ asset('assets/media/logos/employee2.png') }}" style="filter: brightness(111);    height: 40px;"/>
        </a>
        <!--end::Logo-->
        ...
        <div class="d-flex align-items-center">
            ...
            <button class=" p-0 burger-icon burger-icon-left" id="kt_aside_mobile_toggle">
                <span></span>
            </button>
            ...
            <button class=" btn-hover-text-primary p-0 ml-2" style="  background: transparent;    border: 0;" id="kt_header_mobile_topbar_toggle">
    ...
    width: 100%;    padding-top: 20px;">
                        <!-- <img alt="Logo" src="{{ asset('assets/media/logos/employee2.png') }}" style="
    ...
    "/> -->
                    ...
                    <!--begin::Toggle-->
                    <button class="brand-toggle btn-sm px-0" style="background:transparent;border:0;" id="kt_aside_toggle">
    ...
    <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
        ...
        <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
            ...
            <a href="#" class=" btn-xs btn-icon btn-light btn-hover-primary" id="kt_quick_user_close">
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    <div class="symbol-label"
                        style="background-image:url('{{ asset('assets/media/logos/favicon.png') }}')"></div>
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="navi mt-2">
                        ...
                        document.getElementById('logout-form').submit();"
                            class="btn btn-sm  font-weight-bolder py-2 px-5">Sign Out</a>
    ...
    <script src="{{ asset('assets/js/bootstrap-multiselect.js?v=7.0.6') }}"></script>
     <script>
        $( document ).ready(function() {
            // $('input[name="price"]').attr("onkeypress", "return isDecimal(event)");
            // $('input[name="selling_price"]').attr("onkeypress", "return isDecimal(event)");
        });
